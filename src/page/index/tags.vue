<template>
  <div class="avue-tags flex flex-ver">
    <div class="bread-title flex flex-ver">
      <span class="tag_line"></span>
      <span>当前位置：</span>
    </div>
		<el-breadcrumb separator="-">
		  <el-breadcrumb-item :key="item.path" v-for="(item,index) in levelList" v-if="item.name" :class="index == 0?'':'breadorg'">{{item.name}}</el-breadcrumb-item>
		</el-breadcrumb>
    <!-- tag盒子 -->
